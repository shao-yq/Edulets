...
public class CharComponentEditor extends BaseEditor implements MouseMotionListener, MouseListener {
    ...
    CommandActionManager actionManager = null; // = new CommandActionManager();
    ...
    public CharComponentEditor(JFrame frame) {
        super(frame);
    }
    String getAppTitle(){
...
//    EditPanel createEditorPanel(int editMode) {
//        EditPanel panel = null;
//        switch(editMode){
//            case EDIT_STROKE:
//                break;
//            case EDIT_COMPONENT:
//                panel = new CharComponentEditPanel("EditPanel");
//                break;
//            case EDIT_CHARACTER:
//                break;
//        }
//        return panel;
 //   }
    ...
    protected  ResourceBundle initResources(){

        return ShyqUI.loadResources( getResourceName());
    }

    @Override
    protected EditPanel createEditorPanel() {
        return new CharComponentEditPanel("EditPanel");
    }

    @Override
    protected JToolBar createToolBox() {
        JToolBar toolboxStroke = (JToolBar) ShyqUI.createToolbox(commands, "toolboxStroke", 0, 5, toolButtons);
    ...
    private Hashtable initCommands() {
        // install the command table
        actionManager = new CommandActionManager();
    ...
    protected String getResourceName() {
        return "resources.ShyqStrokeRes";
    }

    protected void initCmoponents(JFrame frame) {
        super.initCmoponents(frame);
        ...
        textEditor.getDocument().addUndoableEditListener(undoHandler);
...
//        }
        ...
        add(toolboxLayout, BorderLayout.EAST);
        ...
        editPanel.setStatusBar(statusBar);
        editPanel.setToolBar(toolbar);
    ...
    public Action[] getActions() {
        ...
        //return TextAction.augmentList(textEditor.getActions(), defaultActions);
    }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            for (int i = 0; i < toolButtons.length; i++) {
                if (source == toolButtons[i]) {
                    ...
                    editPanel.pickTool(currentTool);
                    return;
                }
            }
            ...
            for (int i = 0; i < layoutButtons.length; i++) {
                if (source == layoutButtons[i]) {
                    ...
                    editPanel.pickLayout(currentLayout);
                    return;
                }
            }
